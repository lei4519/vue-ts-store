<template>
  <div class="checkout-page">
    ...
    <modal :mdShow="addAddressModal" @closeModal="closeModal">
      ...
      <div slot="message">
        <label style="width: 60%; margin-bottom: 5px; display: flex; justify-content: space-between; align-items:
        center">
          userName: <input type="text" style="padding: 5px" v-model="addressInfo.userName">
        </label>
        <label style="width: 60%; margin-bottom: 5px; display: flex; justify-content: space-between; align-items:
        center">
          streetName: <input type="text" style="padding: 5px" v-model="addressInfo.streetName">
        </label>
        <label style=" width: 60%; margin-bottom: 5px; display: flex; justify-content: space-between; align-items:
        center">
          postCode: <input type="text" style="padding: 5px" v-model="addressInfo.postCode">
        </label>
        <label style=" width: 60%; margin-bottom: 5px; display: flex; justify-content: space-between; align-items:
        center">
          tel: <input type="text" style="padding: 5px" v-model="addressInfo.tel">
        </label>
      </div>
      <div slot="btnGroup">
